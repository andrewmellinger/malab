...
import com.crashbox.malab.common.SampleFuelSlot;
import com.crashbox.malab.common.SampleSlot;
 ...
 */
public class ContainerAutoFurnace extends Container
{
    ...
    public ContainerAutoFurnace(InventoryPlayer inventoryPlayer, TileEntityAutoFurnace tileEntity)
    {
        // DEBUG
        //LOGGER.debug("Constructed!!");

        _tileFurnace = tileEntity;
        _sizeInventory = _tileFurnace.getSizeInventory();

        // Set up all our main interaction slots
        addSlotToContainer(new Slot(_tileFurnace, 0, 88, 17));
        addSlotToContainer(new SlotFurnaceFuel(_tileFurnace, 1, 88, 53));
        addSlotToContainer(new SlotFurnaceOutput(inventoryPlayer.player, _tileFurnace, 2, 148, 35));
    ...
    public void addCraftingToCrafters(ICrafting listener)
    {
        ...
        listener.func_175173_a(this, _tileFurnace);
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (Object crafter : crafters)
        {
            ...
            {
                int tmp = _tileFurnace.getField(n);
        ...
        for (int n = 0; n < _trackedFields.length; ++n)
        {
            _trackedFields[n] = _tileFurnace.getField(n);
        }
    }
    ...
    {
        _tileFurnace.setField(id, data);
    }

    @Override
    public boolean canInteractWith(EntityPlayer playerIn)
    {
        return _tileFurnace.isUseableByPlayer(playerIn);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int slotIndex)
    {
        ...
        int inIndex = TileEntityAutoFurnace.slotEnum.INPUT_SLOT.ordinal();     // 0
        int fuelIndex = TileEntityAutoFurnace.slotEnum.FUEL_SLOT.ordinal();   // 1
        int outIndex = TileEntityAutoFurnace.slotEnum.OUTPUT_SLOT.ordinal();   // 2
