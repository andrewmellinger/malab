...
import com.crashbox.malab.task.*;
 ...
 */
public class EntityAIWorkDroid extends EntityAIBase implements IMessager
{
    public EntityAIWorkDroid(EntityWorkDroid entity)
    {
        setMutexBits(3);
...
//        }
    ...
    // PRIVATES
    private EntityWorkDroid _entity;
