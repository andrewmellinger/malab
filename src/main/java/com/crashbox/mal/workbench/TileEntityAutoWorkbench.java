 ...
 */
public class TileEntityAutoWorkbench extends TileEntityAutoBlockInventory implements ISidedInventory
{
    public static final String NAME = "tileEntityAutoWorkbench";
...
//            LOGGER.debug("Adding controls=" + _controls.getStackInSlot(0));
    ...
    public InventoryAutoWorkbench makeInventory(Container container)
    {
        return new InventoryAutoWorkbench(container);
    }

    private class InventoryAutoWorkbench extends InventoryCrafting
    {
        private InventoryAutoWorkbench(Container container)
        {
            super(container, 3, 3);
        }
    ...
    public static boolean isCrafting(TileEntityAutoWorkbench workbench)
    {
    ...
    public ItemStack mergeIntoBestSlot(ItemStack stack)
    {
        ...
        if (stack.stackSize > 0)
            MALUtils.mergeStacks(candidates.get(0), stack);
    ...
    private class Workbench extends AutoBlockBase
    {
        ...
        {
            return TileEntityAutoWorkbench.this;
        }
        ...
        private void handleWorkerAvailability(MessageWorkerAvailability msg)
        {
            ...
            if (matcher != null)
            {
                TRPutInInventory req = new TRPutInInventory(TileEntityAutoWorkbench.this,
        ...
        private void handleItemRequest(MessageItemRequest msg)
        {
            ...
            {
                TRGetFromInventory req = new TRGetFromInventory(TileEntityAutoWorkbench.this,
                        msg.getSender(), msg.getTransactionID(),
