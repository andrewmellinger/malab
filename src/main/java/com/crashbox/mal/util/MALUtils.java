...
public class MALUtils
{
    ...
    /**
     * Counts the number of droid entities in the specific area.
     * @param world The world object
     * @param center The center of the search area.
     * @param range The range in which to search.
     * @return Number of droids found.
     */
    public static int countDroidsInArea(World world, BlockPos center, int range)
    {
        int x = center.getX();
        int y = center.getY();
        int z = center.getZ();
        ...
        List entities = world.getEntitiesWithinAABB(EntityWorkDroid.class, scanBlock);
     ...
     */
    public static boolean harvestBlockIntoHeld(World world, EntityWorkDroid entity, BlockPos harvestBlock,
                                               ItemStackMatcher matcher)
    {
                                               ...
                                               ItemStackMatcher matcher, boolean mustMatch)
    {
        ...
        if (targetStack == null)
        {
            targetStack = MALUtils.identifyWillDrop(world, harvestBlock, matcher);
            if (targetStack == null)
                return false;
        }
        else
        {
            ...
            if (mustMatch)
            {
                if (!MALUtils.willDrop(entity.getEntityWorld(), harvestBlock, new ItemStackMatcher(targetStack)))
                    return false;
            }
        }
